...
def process_file(dpath):
    ...
    filenameOut =  f'/mnt/data/AurelieB_other/{Cell_Assembly_folder}/CellAssembly_dict.pkl'
    with open(filenameOut, 'rb') as pickle_file:
        CellAssembly_dict = pickle.load(pickle_file)

    filenameOut =  f'/mnt/data/AurelieB_other/{Cell_Assembly_folder}/CellAssembly_members.pkl'
    with open(filenameOut, 'rb') as pickle_file:
