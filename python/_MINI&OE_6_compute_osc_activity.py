...
destination_folder= f"//10.69.168.1/crnldata/forgetting/Aurelie/MiniscopeOE_analysis/Exploration_task/5_OscActivity_{FolderNameSave}{AnalysisID}" if local else f"/crnldata/forgetting/Aurelie/MiniscopeOE_analysis/Exploration_task/5_OscActivity_{FolderNameSave}{AnalysisID}"
...
source_script = "C:/Users/Manip2/SCRIPTS/HayLabAnalysis/python/_MINI&OE_6_compute_osc_activity.py" if local else "/home/aurelie.brecier/HayLabAnalysis/python/_MINI&OE_6_compute_osc_activity.py"
